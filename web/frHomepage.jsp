    ...
    <body id="page-top">
                ...
                <div class="row">
                    <form action="groupHomepage.jsp">
                        <div class="col offset-lg-8 text-center mx-auto">
                            <i class="fa fa-handshake-o fa-4x white mb-3 sr-icons" data-aos="fade" data-aos-duration="200" data-aos-delay="600" data-aos-once="true"></i>
                            ...
                            <p class="text-faded mb-4">Our application thrives off the group dynamic. Here, you can access multiple group activities: whether you want to create, join, or view the standings in a group, you can do it here!</p><input type="submit" class="btn btn-light btn-xl js-scroll-trigger" role="button" value="Take me to Groups"/>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <section class="text-white bg-dark">
            <form action="activityHomepage.jsp">
                <div class="container text-center">
                    ...
                    <input hidden type="text" name="loggedname" value="${user.username}" readonly="readonly"/>
                    <p>Do it here!</p><input class="btn btn-light btn-xl sr-button" role="button" data-aos="zoom-in" data-aos-duration="400" data-aos-once="true" type="submit" value="Log a Workout"/>
                </div>
            </form>
        </section>    
        ...
        <section id="contact">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 text-center ml-auto"><i class="fa fa-dashboard fa-3x mb-3 sr-contact" data-aos="zoom-in" data-aos-duration="300" data-aos-once="true"></i>
                        <form action="useractivities1">
                            <input hidden type="text" name="loggedname" value="${user.username}" readonly="readonly"/>
                            <input type="submit" class="btn btn-dark btn-xl js-scroll-trigger" role="button" value="Your Activity dashboard"/>
                        </form>
                    </div>
                    <div class="col-lg-4 text-center mr-auto"><i class="fa fa-bar-chart fa-3x mb-3 sr-contact" data-aos="zoom-in" data-aos-duration="300" data-aos-delay="300" data-aos-once="true"></i>
                        <form action="updatePhysique.jsp">
                            <input hidden type="text" name="loggedname" value="${user.username}" readonly="readonly"/>
                            <input type="submit" class="btn btn-dark btn-xl js-scroll-trigger" role="button" value="Update measurements"/>
                        </form>
                    </div>
                    <div class="col-lg-4 text-center mr-auto"><i class="fa fa-cogs fa-3x mb-3 sr-contact" data-aos="zoom-in" data-aos-duration="300" data-aos-delay="300" data-aos-once="true"></i>
                        <form action="updateAccount.jsp">
                            <input hidden type="text" name="loggedname" value="${user.username}" readonly="readonly"/>
                            <input type="submit" class="btn btn-dark btn-xl js-scroll-trigger" role="button" value="update account details"/>
                        </form>
                    </div>                
                </div>
            </div>
